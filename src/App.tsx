...
<div className="fixed top-4 left-1/2 -translate-x-1/2 z-50 bg-black/50 backdrop-blur-md px-6 py-3 flex justify-center rounded-full shadow-lg">
  <div className="flex gap-6 items-center text-white text-2xl">
    <a href="#index" className="group relative p-2 rounded-full hover:bg-purple-600 transition-all duration-300 transform hover:scale-125">
    ...
    <a href="#about" className="group relative p-2 rounded-full hover:bg-purple-600 transition-all duration-300 transform hover:scale-125">
      <InfoIcon sx={{ fontSize: 40 }} />
      <span className="absolute -bottom-10 left-1/2 -translate-x-1/2 bg-gray-900 text-white text-sm px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity duration-300">
        About
      </span>
    </a>
    <a href="#stack" className="group relative p-2 rounded-full hover:bg-purple-600 transition-all duration-300 transform hover:scale-125">
      <LayersIcon sx={{ fontSize: 40 }} />
      <span className="absolute -bottom-10 left-1/2 -translate-x-1/2 bg-gray-900 text-white text-sm px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity duration-300">
        Stack
      </span>
    </a>
    <a href="#project" className="group relative p-2 rounded-full hover:bg-purple-600 transition-all duration-300 transform hover:scale-125">
